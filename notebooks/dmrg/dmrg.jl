...
# ╔═╡ 327556f4-9f91-4047-b6d7-22c9a9012472
...
function grow_right(R, A, W)
    error("Hands-on: the mirror image of grow_left")
end
...
function apply_Heff(A, L, W, R)
    error("Hands-on: contract L – A – W – R, leaving the bra legs of A open")
end
...
function dmrg(ψ::MPS, mpo; maxsweeps = 20, tol = 1e-10, verbose = true)
    error("Hands-on: assemble the sweep from the steps above")
end
